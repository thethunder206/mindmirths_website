...
def depression_survey_uwc(request):
    ...
    if request.method == 'POST':
        ...
        print(lst)
        print(final_amt)
        return redirect('output-uwc/yes')
...
def output_uwc(request):
    ...
    if final_amt == 8 or final_amt == 9:
        ...
        add = "If you need immediate help, you can reach the Suicide & Crisis Lifeline by calling or texting 988 or using the chat box at 988lifeline.org. You can also text “MHA” to 741-741 to reach the Crisis Text Line. Warmlines are an excellent place for non-crisis support."
    elif final_amt <= 18 and final_amt > 8:
    ...
    print(data)
    data = data
    return render(request, 'survey/yes.html', {'data': data, 'add': add, 'final_amt': final_amt})
...
def chatbot(request):
    ...
    return render(request, 'survey/chatbot.html')


def quiz_page(request):
    return render(request, 'survey/quiz_page.html')

def therapist(request):
    return render(request, 'survey/therapist.html')
